...
function checkResults() {
  ...
  if (score === 7) {
    ...
    <h4 class="song">It's a nice day outside, or inside. Either way, pump up the music and dance to enjoy it!</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
    <h4 class="song">Glad you're feeling good. Treat yourself to something nice today while you enjoy these sick beats. You deserve it :D</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
    <h4 class="song">Happy you're doing well today! Hit up a friend and share something cool with them (they might enjoy your playlist too)</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
    <h4 class="song">There's something refreshing about spending time outside. Channel your inner country and breathe in the open road! </h4><iframe src="https://open.spotify.com/embed/playlist/4C0I1PcvcNotVDfSXRRogI" 
    width="100%" height="380" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    `)
  } else if (score === 14) {
    // resultsBtn.css('background','#FFD400');
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
    <h4 class="song">It's okay to feel down sometimes. Take some time to acknowledge how you feel and let it all out. You got this :)</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">There's no shame in being upset. Something that helps me: the worst days are still only 24 hours long! We believe in you <3 </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">It's okay if you need time by yourself, but theres no shame in relying on friends, family or others if you have to. </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Even cowboys get the blues...if you need to be distracted, try some relaxing hobbies to pass the time. </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Listen to something loud and fast! Being angry sometimes is okay too.</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Your feelings are valid no matter what. One way to let it out is to exercise (enjoy this playlist while you do, haha)</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Take a second to breathe and pause to assess the situation. Sometimes taking it slow is a good thing when you're angry as well.</h4><iframe src="https://open.spotify.com/embed/playlist/6E5vzipZVkkdLDgKCrlsgn" 
    width="100%" height="380" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Try writing out why you're mad in a letter or email. Once you've perfected and completed it, delete it once you're ready to let go. </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Jitters are completely normal. Distract yourself with something fast and loud!</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">If something has the potential to go horribly wrong, it also has the potential of going fantastically well. You never know! </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Make sure to treat yourself once you've finished what you're nervous or tense about. Get excited for it!</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Talk it out with a friend! Being nervous or tense together is better than worrying alone. </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song"> Express how you feel in whatever way you can. Make charts to organize your thoughts, or write emails or letters to yourself. Surprising how much it can help!</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">You've been working hard. Go get some rest! Your body will thank you.</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Need to go to sleep but can't? Try tensing your muscles for a few seconds, then releasing them completely. Repeat a few times, and you'll be asleep before you know it! Goodnight~~</h4>
     <iframe src="https://open.spotify.com/embed/playlist/0JROZmzXdpVRFkE7JeKEJJ" width="100%" height="380" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Sometimes life gets in the way of a good sleep schedule. Little by little, take the time to make relaxing part of your day. </h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Studies have shown that people who sleep between 8-9.5 hours at night tend to wake up happier. Gotta start somewhere!</h4>
    ...
    resultsShow.append(`
    <h3>Here are your results!</h3>
     <h4 class="song">Time to hit the hay...give your eyes a break! You'll see how much better you'll feel :)</h4>
